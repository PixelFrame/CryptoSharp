...
namespace DES_lib
{
    class DES_Table
    {
		...
		private readonly static int[] PC2 =
		{
			14, 17, 11, 24, 1 , 5 ,
			3 , 28, 15, 6 , 21, 10,
			23, 19, 12, 4 , 26, 8 ,
		...
		private readonly static int[] IP =
		{
		...
		private readonly static int[] IP_T =
		{
		...
		private readonly static int[,,] S = new int[8, 4, 16]
		{
			{
		...
		public static QWORD Swap_PC1(QWORD input)
		{
			QWORD output = 0;
			for (int i = 0; i < 56; ++i)
			{
		...
		public static QWORD Swap_PC2(QWORD input)
		{
			QWORD output = 0;
			for (int i = 0; i < 48; ++i)
			{
		...
		public static QWORD Expand_R(QWORD input)
		{
			input <<= 32;
			QWORD output = 0;
			for (int i = 0; i < 48; ++i)
		...
		public static DWORD Swap_S(QWORD input)
		{
			byte seg;
			DWORD output = 0;
			for (int i = 0; i < 8; ++i)
		...
		public static DWORD Swap_P(DWORD input)
		{
			DWORD output = 0;
			for (int i = 0; i < 32; ++i)
			{
		...
		public static QWORD Swap_T_IP(QWORD input)
		{
			QWORD output = 0;
			for (int i = 0; i < 64; ++i)
			{
